...
namespace fl {
  ...
  protected:
    ...
    virtual void process(const std::string& input, std::ostream& writer, const std::string& inputFormat,
                         const std::string& outputFormat, const std::map<std::string, std::string>& options);
    ...
    virtual void exportAllExamples(const std::string& from, const std::string& to, const std::string& examplesPath,
   ...
   engines or evaluating the benchmark
    ...
    virtual void benchmark(const std::string& fllFile, const std::string& fldFile, int runs,
    ...
    /**
      ...
      engines or evaluating the benchmark
     */
    virtual void benchmarks(const std::string& fllFileList, const std::string& fldFileList, int runs,
                            std::ofstream* writer = fl::null) const;
