...
namespace fl {
  ...
  public:
    explicit PiShape(const std::string& name = "", scalar bottomLeft = fl::nan, scalar topLeft = fl::nan,
                     scalar topRight = fl::nan, scalar bottomRight = fl::nan, scalar height = 1.0);
