...
namespace fl {
  ...
  public:
    ...
    struct FL_API Element {
      ...
      Element(const std::string& name, const std::string& description, Type type, Unary unary, int precedence = 0,
              int associativity = -1);
      Element(const std::string& name, const std::string& description, Type type, Binary binary, int precedence = 0,
              int associativity = -1);
      virtual ~Element();
  ...
  public:
    ...
    explicit Function(const std::string& name = "", const std::string& formula = "", const Engine* engine = fl::null);
