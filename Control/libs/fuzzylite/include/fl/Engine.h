...
namespace fl {
  ...
  public:
     ...
     */
    virtual void configure(const std::string& conjunction, const std::string& disjunction,
    ...
    /**
      ...
      rule blocks
     */
    virtual void configure(TNorm* conjunction, SNorm* disjunction, TNorm* implication, SNorm* aggregation,
