...
namespace fl {
  ...
  public:
     ...
     */
    virtual std::string toString(Engine* engine, InputVariable* a, InputVariable* b, int values,
    ...
    /**
     ...
     variables on the output variables
     */
    virtual std::string toString(Engine* engine, InputVariable* a, InputVariable* b, std::istream& reader,
                                 const std::vector<OutputVariable*>& outputVariables) const;
    ...
    /**
     ...
     @param outputVariables are the output variables to create the surface for
     */
    virtual void toFile(const std::string& filePath, Engine* engine, InputVariable* a, InputVariable* b, int values,
                        FldExporter::ScopeOfValues scope, const std::vector<OutputVariable*>& outputVariables) const;
    ...
    /**
     ...
     @param outputVariables are the output variables to create the surface for
     */
    virtual void toFile(const std::string& filePath, Engine* engine, InputVariable* a, InputVariable* b,
    ...
    /**
     ...
     @param outputVariables are the output variables to create the surface for
     */
    virtual void writeScriptImportingDataFrame(const Engine* engine, std::ostream& writer, InputVariable* a,
                                               InputVariable* b, const std::string& dataFramePath,
                                               const std::vector<OutputVariable*>& outputVariables) const;
    ...
    /**
     ...
     @param outputVariables are the output variables to create the surface for
     */
    virtual void writeScriptExportingDataFrame(Engine* engine, std::ostream& writer, InputVariable* a, InputVariable* b,
  ...
  protected:
    ...
    /**
     ...
     @param outputVariables are the output variables to create the surface for
     */
    virtual void writeScriptPlots(std::ostream& writer, InputVariable* a, InputVariable* b,
                                  const std::vector<OutputVariable*>& outputVariables) const;
